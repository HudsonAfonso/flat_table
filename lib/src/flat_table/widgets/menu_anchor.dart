...
class MenuBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return _MenuBarAnchor(menuChildren: children, controller: controller, clipBehavior: clipBehavior, style: style);
  }
      ...
      leadingIcon: ExcludeFocus(
        child: IgnorePointer(
          child: ConstrainedBox(
            constraints: const BoxConstraints(maxWidth: Checkbox.width, maxHeight: Checkbox.width),
            child: Checkbox(value: value, tristate: tristate, onChanged: onChanged, isError: isError),
          ),
        ),
      ),
...
class _MenuDirectionalFocusAction extends DirectionalFocusAction {
  ...
  void invoke(DirectionalFocusIntent intent) {
    ...
    assert(
      _debugMenuInfo('In _MenuDirectionalFocusAction, current node is ${anchor.widget.childFocusNode?.debugLabel}, '
...
class _MenuPanelState extends State<_MenuPanel> {
  ...
  Widget build(BuildContext context) {
    ...
    final EdgeInsetsGeometry resolvedPadding = padding
        .add(EdgeInsets.symmetric(vertical: dy, horizontal: dx))
